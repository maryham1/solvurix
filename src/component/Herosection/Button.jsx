function Button({ type, children, icon }) {
  const baseStyles =
    "px-10 py-4 text-center rounded-lg capitalize outline-0 flex gap-2 items-center justify-center text-xl font-semibold laptop:px-8 laptop:py-4 laptop:justify-normal laptop:text-xl tablet:text-sm tablet:px-6 tablet:py-3";
  const variants = {
    blueBg: "bg-blue-600 ",
