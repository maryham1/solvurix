...
function Technology() {
  return (
    <section className="bg-blue-50/50  py-10 px-7 w-full laptop:px-2 laptop:py-20">
      <div className="flex flex-col justify-center items-center gap-10">
        <div className="text-center space-y-5 laptop:space-y-10">
          <h1 className="text-[#0A192F] font-bold text-2xl capitalize laptop:text-6xl">
        ...
        <div className="flex flex-col gap-10 laptop:flex-row ">
          {technology.map((tech) => (
            <div className=" flex flex-col gap-3 justify-center items-center m-auto rounded-2xl  laptop:gap-5">
              <figure className="bg-white p-2 w-[100px] h-[100px] rounded-2xl flex items-center justify-center shadow-md hover:scale-[1.1]">
                {tech.icon}
              </figure>
              <h1 className="font-semibold text-lg laptop:text-2xl">
                {tech.name}
              </h1>
              <p className="text-gray-600 text-sm text-center laptop:text-lg">
                {tech.info}
              </p>
            </div>
          ))}
