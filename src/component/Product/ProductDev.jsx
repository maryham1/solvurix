...
function ProductDev() {
  return (
    <div className="space-y-3 w-auto laptop:w-[800px] laptop:space-y-7">
      <div className="flex gap-1 items-center pl-5">
        <div className="bg-blue-600  w-[10px] h-[10px] rounded-full"></div>
        <h4 className=" text-blue-600 uppercase text-sm laptop:text-lg">
          primary focus
        </h4>
      </div>
      <p className="text-black capitalize text-2xl font-semibold laptop:text-4xl">
        product development & innovation
      </p>
      <p className="text-sm text-gray-600 laptop:text-[22px]">
        ...
        {tech.map((th) => (
          <li className="flex gap-5 items-center laptop:gap-6">
            ...
            <div className="">
              ...
              <p className="text-gray-600 text-sm laptop:text-lg">{th.info}</p>
            </div>
          </li>
        ))}
      </ul>
